...
pub struct Instance {
    ...
    /// Bodies that passed the door AND landed in the store (202). v1 note
    /// (S6b): 006 counted "emitted to stdout"; a door-accepted event whose
    /// put fails counts in NEITHER bucket — see handler.rs's 500 branch.
